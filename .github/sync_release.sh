...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Galivan_MiSTer.git"
CORE_NAME=(Arcade-Galivan)
...
UPSTREAM_CORE_NAME=(Arcade-Galivan)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Galivan.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Galivan.rbf)
